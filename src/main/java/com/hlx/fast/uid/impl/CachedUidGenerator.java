...
import com.hlx.fast.uid.buffer.BufferPaddingExecutor;
import com.hlx.fast.uid.buffer.RejectedPutBufferHandler;
import com.hlx.fast.uid.buffer.RejectedTakeBufferHandler;
import com.hlx.fast.uid.buffer.RingBuffer;
...
public class CachedUidGenerator extends DefaultUidGenerator implements DisposableBean {
    ...
    public CachedUidGenerator(FastProperties uidProperties) {
        super(uidProperties);
    }
    ...
    protected List<Long> nextIdsForOneSecond(long currentSecond) {
        ...
        long firstSeqUid = bitsAllocator.allocate(currentSecond - uidProperties.getIdEpochSeconds(), workerId, 0L);
    ...
    private void initRingBuffer() {
        ...
        this.bufferPaddingExecutor = new BufferPaddingExecutor(ringBuffer, currentSecond -> nextIdsForOneSecond(currentSecond), usingSchedule);
        if (usingSchedule) {
