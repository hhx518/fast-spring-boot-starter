 ...
 */
package com.hlx.fast.uid.impl;

import com.hlx.fast.properties.FastProperties;
import com.hlx.fast.uid.BitsAllocator;
import com.hlx.fast.uid.UidGenerator;
import com.hlx.fast.uid.exception.UidGenerateException;
import com.hlx.fast.uid.utils.DateUtils;
...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
    ...
    protected FastProperties uidProperties;
    ...
    public DefaultUidGenerator(FastProperties uidProperties) {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        bitsAllocator = new BitsAllocator(uidProperties.getIdTimeBits(), uidProperties.getIdWorkerBits(), uidProperties.getIdSeqBits());
        ...
        LOGGER.info("Initialized bits(1, {}, {}, {}) for workerID:{}", uidProperties.getIdTimeBits(), uidProperties.getIdWorkerBits(), uidProperties.getIdSeqBits(), workerId);
    }
    ...
    public String parseUID(long uid) {
        ...
        Date thatTime = new Date(TimeUnit.SECONDS.toMillis(uidProperties.getIdEpochSeconds() + deltaSeconds));
    ...
    protected synchronized long nextId() {
        ...
        if (currentSecond < lastSecond) {
            ...
            if (uidProperties.isIdEnableBackward()) {
                if (refusedSeconds <= uidProperties.getIdMaxBackwardSeconds()) {
        ...
        return bitsAllocator.allocate(currentSecond - uidProperties.getIdEpochSeconds(), workerId, sequence);
    }
    ...
    private long getCurrentSecond() {
        ...
        if (currentSecond - uidProperties.getIdEpochSeconds() > bitsAllocator.getMaxDeltaSeconds()) {
